...
public class ItemFoodZGC extends ItemFood
  {
    ...
    public ItemFoodZGC(int p_i45339_1_, float p_i45339_2_, boolean p_i45339_3_)
      {
      ...
      public ItemFoodZGC(int p_i45340_1_, boolean p_i45340_2_)
      {
       ...
       */
      public ItemFoodZGC setPotionEffect(int p_77844_1_, int p_77844_2_, int p_77844_3_, float p_77844_4_)
      {
       ...
       */
      public ItemFoodZGC setAlwaysEdible()
      {
    ...
    public void registerIcons(IIconRegister iconRegister)
      {
        itemIcon = iconRegister.registerIcon(this.getMincraftTexture(this.getUnwrappedUnlocalizedName(this.getUnlocalizedName())));
      }
    ...
    protected String getUnwrappedUnlocalizedName(String unlocalizedName)
     ...
     public String getMincraftTexture(String texture)
     {
         return "minecraft:" + texture.substring(texture.indexOf(":") + 1);
     }
  }
